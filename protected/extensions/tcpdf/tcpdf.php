...
class TCPDF {
	 ...
	 */
	public function SetFont($family = 'helvetica', $style='', $size=0, $fontfile='', $subset='default') {
	 ...
	 * @param $dest (string) Destination where to send the document. It can take one of the following values:
         * <ul>
         *  <li>I: send the file inline to the browser (default). The plug-in is used if available. 
         *      The name given by name is used when one selects the "Save as" option on the link generating the PDF.</li>
