 ...
 */
return array (
  'Action class {class} must implement the "run" method.' => 'Kelas action {class} mesti melaksanakan method "run".',
  ...
  'Unable to find "{column}" in table "{table}".' => 'Kolum "{column}" tiada didalam jadual "{table}".',
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yii::beginProfile() and Yii::endProfile() be properly nested.' => 'CProfileLogRoute menemukan blok kod tidak sama "{token}". Pastikan panggilan Yii::beginProfile() dan Yii::endProfile() di-nested dengan benar.',
  ...
  'Please fix the following input errors:' => 'Harap maaf, terdapat kesalahan seperti berikut:',
  ...
  'The file "{file}" cannot be uploaded. Only files with these extensions are allowed: {extensions}.' => 'Fail "{file}" tidak boleh dimuat naik. Hanya fail ini sahaja dibenarkan: {extensions}.',
  ...
  'The verification code is incorrect.' => 'Kod verifikasi tidak benar.',
  ...
  '{attribute} must be an integer.' => 'Sila masukkan nilai {attribute} sebagai no bulat.',
